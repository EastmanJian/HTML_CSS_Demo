...
function generateFontAwesomeList() {
    ...
    for (var i=0; i<faList.length; i++) {
        ...
        html += '&nbsp;&nbsp;&nbsp;<i class="fa ' + faList[i] + ' fa-5x" aria-hidden="true"></i></span><br/>';
    }
    content.innerHTML = html;
}

window.addEventListener("load", generateFontAwesomeList);